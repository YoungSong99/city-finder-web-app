...
ActiveRecord::Schema[7.1].define(version: 2024_08_05_202814) do
  ...
  create_table "gym_cities", force: :cascade do |t|
    t.integer "gym_id"
    t.integer "city_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "language_cities", force: :cascade do |t|
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "recommend_family_type", default: [], array: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "user_family_type", default: [], array: true
